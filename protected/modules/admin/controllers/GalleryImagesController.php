...
//		$dataProvider=new CActiveDataProvider('GalleryImages');
...
//		));
	 ...
	 * @param GalleryImages $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='gallery-images-form')
		{
